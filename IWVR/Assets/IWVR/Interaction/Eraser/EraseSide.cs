...
public class EraseSide : MonoBehaviour
{
        ...
        set
        {
            if (_hoveringInteractable != value)
            {
                if (_hoveringInteractable != null)
                {
                    ...
                    _hoveringInteractable.SendMessage("OnEraserHoverEnd", this, SendMessageOptions.DontRequireReceiver);
                }
                ...
                if (_hoveringInteractable != null)
                {
                    ...
                    _hoveringInteractable.SendMessage("OnEraserHoverBegin", this, SendMessageOptions.DontRequireReceiver);
    ...
    private void UpdateHovering()
    {
        ...
        Physics.OverlapBoxNonAlloc(hoverSphereTransform.position - new Vector3(0, flScaledSphereRadius * boxMult - flScaledSphereRadius, 0),
        ...
        foreach (Collider collider in overlappingColliders)
        {
            ...
            if (distance < closestDistance && !collider.Equals(this.GetComponentInParent<BoxCollider>()))
            {
