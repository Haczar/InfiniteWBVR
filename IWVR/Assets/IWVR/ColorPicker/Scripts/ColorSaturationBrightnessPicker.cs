...
public class ColorSaturationBrightnessPicker : MonoBehaviour
{
	...
	{
		backgroundMaterial.SetColor("_Color", new HSBColor(color.h, 0, 0).ToColor());
    ...
    {
		transform.parent.transform.parent.BroadcastMessage("SetSaturationBrightness", new Vector2(point.x, point.y));
    }
