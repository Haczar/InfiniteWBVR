...
namespace Valve.VR.InteractionSystem
{
    ...
    public class ModifiedTeleport : MonoBehaviour
    {
        ...
        //-------------------------------------------------
        private static ModifiedTeleport _instance;
        public static ModifiedTeleport instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = GameObject.FindObjectOfType<ModifiedTeleport>();
                }
        ...
        private void TeleportPlayer()
        {
            ...
            TeleportPoint teleportPoint   = teleportingToMarker as TeleportPoint ;
            BoardTelePoint boardTelePoint = teleportingToMarker as BoardTelePoint;
